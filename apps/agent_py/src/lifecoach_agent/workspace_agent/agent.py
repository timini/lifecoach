...
The six write tools (archive_messages, add_calendar_event,
edit_calendar_event, delete_calendar_event, add_task, complete_task) live in the sub-agent's toolset too, so a future
