...
const STATE_DIRECTIVE: Record<UserState, string> = {
  ...
  workspace_connected:
    'User granted Google Workspace access. Use the eight workspace tools (triage_inbox, find_workspace, archive_messages, add_calendar_event, edit_calendar_event, delete_calendar_event, add_task, complete_task) when the user asks something that requires their workspace. Never speculate about their workspace contents — call the tool.',
};
