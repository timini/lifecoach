  ...
  return (
    <>
      ...
      <aside
        aria-hidden={!open}
        className={cn(
          'fixed inset-y-0 left-0 z-40 flex w-72 max-w-[85vw] flex-col border-r border-border/90 bg-background shadow-[2px_0_12px_rgba(45,58,50,0.08)] transition-transform duration-200 ease-out',
