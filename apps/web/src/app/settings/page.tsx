    ...
    <ChatShell header={header} footer={footer}>
      ...
      {activeTab === 'account' ? (
        <section className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3 rounded-[var(--radius-surface)] border border-border bg-muted/40 p-3">
            <div className="flex-1 text-xs text-foreground/75">
              Delete all my data
              <span className="ml-2 inline-flex rounded-full bg-muted px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">
                Coming soon
              </span>
            </div>
            <Button variant="subtle" size="md" disabled aria-disabled="true">
              Delete
            </Button>
          </div>
        </section>
