...
_FIND_DESCRIPTION = (
    ...
    '"list my calendar IDs", "open tasks for the project review"). Do NOT use for inbox triage — call '
...
1. Pick the right read tool(s):
   ...
   - Direct calendar-list / calendar-ID requests ("list calendars", "show my calendar IDs", "find the Family calendar"): list_calendars. Do not search Gmail unless the user explicitly asks for messages/emails.
