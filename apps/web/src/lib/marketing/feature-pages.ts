...
export const featurePages = [
  ...
  },
  {
    ...
    metaTitle: 'AI coach for ADHD task initiation | tranquil.coach',
    description:
    ...
    keyphrases: ['AI coach for ADHD', 'ADHD task initiation app', 'executive function support'],
    useCases: [
    ...
    faq: [
      {
        ...
        answer:
          'No. It is not diagnosis, therapy, or medication management. It is a practical coach for planning, task initiation, and reducing daily friction.',
      },
      {
  ...
  },
  {
    ...
    keyphrases: ['AI to calm anxiety', 'rumination tracking app', 'anxiety planning coach'],
    useCases: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes. The coach can help capture the loop, separate facts from interpretations, and decide whether a next action is useful.',
      },
      {
  ...
  },
  {
    ...
    keyphrases: ['AI wellness coach', 'sleep movement nutrition support', 'daily wellness coach'],
    useCases: [
