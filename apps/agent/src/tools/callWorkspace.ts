...
import {
  ...
  sanitiseStderr,
  truncateStdout,
} from '../agents/workspaceAgent/gwsExec.js';
...
// Re-exports preserved for callers (and the soon-to-be-deleted call-site
// tests) — these moved into `agents/workspaceAgent/gwsExec.ts`.
export {
  AUTH_ERROR_CODES,
  type ExecFileLike,
  type ExecFileResult,
...
// CallWorkspaceErrorCode is now an alias for the shared GwsErrorCode.
export type CallWorkspaceErrorCode = GwsErrorCode;
